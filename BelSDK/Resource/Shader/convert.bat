...
%SHADER_ARCHIVER% -i %INTERMEDIATE_ROOT% -n Sample -o %CONTENT_ROOT%/Sample.bshar
if ERRORLEVEL 1 GOTO :ERROR

%SHADER_ARCHIVER% -i %INTERMEDIATE_ROOT% -n ToneMapping -o %CONTENT_ROOT%/ToneMapping.bshar
if ERRORLEVEL 1 GOTO :ERROR
