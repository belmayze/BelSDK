...
bool RootSignature::create()
{
    ...
    Microsoft::WRL::ComPtr<ID3D12RootSignature> p_root_signature;
    {
        ...
        // CBV: 16
        {
            ...
            ranges[cRangeTypeCBV].NumDescriptors     = 16;
        ...
        // SRV: 48
        {
            ...
            ranges[cRangeTypeSRV].NumDescriptors     = 48;
            ranges[cRangeTypeSRV].BaseShaderRegister = 16;
        ...
        // UAV: 16
        {
            ...
            ranges[cRangeTypeUAV].NumDescriptors     = 16;
            ranges[cRangeTypeUAV].BaseShaderRegister = 16 + 48;
        ...
        // Sampler: 16
        {
            ...
            ranges[cRangeTypeSampler].NumDescriptors     = 16;
